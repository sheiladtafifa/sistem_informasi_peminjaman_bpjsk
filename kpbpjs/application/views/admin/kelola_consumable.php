<div class="container-fluid">
  ...
  <div class="container mt-3" style="width: 40rem;">
    ...
    <div class="container">
    <div class="mt-3" align="center"><h1>Kelola Consumable</h1></div>
    
    <div class="row mt-3">
      <div class="col-md-6">
        <form action="<?= base_url('index.php/admin/kelola_consumable')?>" method="post">
      ...
      <table class="table table-striped mt-3">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> 
                <a href="<?= base_url('index.php/admin/edit_consumable/');?><?= $consumable['no_consumable'];?>" class="badge badge-success">Edit</a>
                <a href="<?= base_url('index.php/admin/hapus_consumable/');?><?= $consumable['no_consumable'];?>" class="badge badge-danger" onclick="return confirm('Yakin ingin menghapus data?');">Hapus</a> 
              </td>
            </tr>
          <?php endforeach; ?>
          </tbody>
    ...
    <div class="mt-3" align="center">
        ...
        <?php echo anchor('index.php/admin/tambah_consumable', '<div class="btn btn-primary">
            Tambah Data
          </div>') ?>
