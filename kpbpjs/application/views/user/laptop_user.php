<div class="container-fluid">
         <!-- Page Heading -->
  <div class="mt-3" align="center" margin="center"><h1>LAPTOP</h1></div>
   <!-- /.container-fluid -->
        <div class="container mt-3" style="width: 40rem;">
          <form class="form-horizontal" method="post" action="<?php base_url('user/laptop') ?>">
          <div class="card" style="width: 40rem;">
          <div class="card-header bg-primary text-white">Form LAPTOP</div>
          <div class="card-body">
          ...
          <div class="ml-3 mt-3">
              <button type="submit" class="btn btn-primary">Simpan</button>
               <?php echo anchor('index.php/user/tampil_laptop', '<div class="btn btn-primary">
            Tampil
          </div>') ?>
